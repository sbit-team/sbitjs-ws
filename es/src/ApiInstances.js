...
var ApisInstance = function () {
    ...
    ApisInstance.prototype.connect = function connect(cs, connectTimeout) {
        ...
        this.init_promise = this.ws_rpc.login(rpc_user, rpc_password).then(function () {
            ...
            _this._db = new SBitApi(_this.ws_rpc, "database");
            _this._net = new SBitApi(_this.ws_rpc, "network_broadcast");
            _this._hist = new SBitApi(_this.ws_rpc, "history");
            if (enableCrypto) _this._crypt = new SBitApi(_this.ws_rpc, "crypto");
